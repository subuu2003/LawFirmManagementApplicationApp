...
const mockParalegals = [
  { id: 1, name: 'Charlie Davis', email: 'charlie@example.com', role: 'Paralegal' },
];

export default function BranchParalegalsPage() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Branch Paralegals</h2>
          <p className="text-sm text-gray-500 mt-1">List of paralegals assigned to this branch.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-100">
            {mockParalegals.map((para) => (
              <tr key={para.id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-6 py-4 text-sm text-gray-500">{para.email}</td>
                <td className="px-6 py-4">
