...
const mockAdvocates = [
  { id: 1, name: 'Alice Smith', email: 'alice@example.com', role: 'Senior Advocate' },
  { id: 2, name: 'Bob Johnson', email: 'bob@example.com', role: 'Associate Advocate' }
];

export default function BranchAdvocatesPage() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Branch Advocates</h2>
          <p className="text-sm text-gray-500 mt-1">List of advocates assigned to this branch.</p>
        </div>
          ...
          <tbody className="divide-y divide-gray-100">
            {mockAdvocates.map((adv) => (
              <tr key={adv.id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-6 py-4 text-sm text-gray-500">{adv.email}</td>
                <td className="px-6 py-4">
