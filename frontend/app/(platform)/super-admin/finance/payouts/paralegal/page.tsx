...
const mockPayouts = [
  { id: 'PAY-PARA-301', date: '2026-04-15', name: 'Ravi Prakash', amount: '₹12,000', method: 'UPI', status: 'Completed' },
  { id: 'PAY-PARA-302', date: '2026-04-18', name: 'Neha Sharma', amount: '₹15,000', method: 'Bank Transfer', status: 'Completed' },
  { id: 'PAY-PARA-303', date: '2026-04-20', name: 'Karan Mehra', amount: '₹9,500', method: 'UPI', status: 'Failed' },
  { id: 'PAY-PARA-304', date: '2026-04-27', name: 'Pooja Singh', amount: '₹18,000', method: 'Bank Transfer', status: 'Processing' },
];

export default function ParalegalPaymentsPage() {
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col font-sans">
      ...
      <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50/30">
        <div>
          <h2 className="text-xl font-black text-slate-900">Paralegal Distributions</h2>
          <p className="text-sm font-medium text-slate-500 mt-1">Manage reimbursements and standard payouts for paralegal staff.</p>
        </div>
        <div className="flex items-center gap-3">
           <div className="text-right">
             <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Total Distributed</p>
             <p className="text-xl font-black text-blue-600">₹54,500</p>
           </div>
        </div>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-50 border-b border-slate-200">
              ...
              <th className="py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider">Paralegal</th>
